/* @ts-self-types="./stark_prover.d.ts" */
...
export class StarkProverWasm {
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        StarkProverWasmFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_starkproverwasm_free(ptr, 0);
    }
    /**
     ...
     * @returns {string}
     */
    generateSharpeProof(bot_id, num_queries) {
        let deferred2_0;
        let deferred2_1;
        try {
            const ptr0 = passStringToWasm0(bot_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.starkproverwasm_generateSharpeProof(this.__wbg_ptr, ptr0, len0, num_queries);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
     ...
     * @returns {string}
     */
    generateSharpeProofWithProgress(bot_id, num_queries, callback) {
        let deferred2_0;
        let deferred2_1;
        try {
            const ptr0 = passStringToWasm0(bot_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.starkproverwasm_generateSharpeProofWithProgress(this.__wbg_ptr, ptr0, len0, num_queries, callback);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    constructor() {
        const ret = wasm.starkproverwasm_new();
        this.__wbg_ptr = ret >>> 0;
        StarkProverWasmFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
}
if (Symbol.dispose) StarkProverWasm.prototype[Symbol.dispose] = StarkProverWasm.prototype.free;
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./stark_prover_bg.js": import0,
    };
}

const StarkProverWasmFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_starkproverwasm_free(ptr >>> 0, 1));
