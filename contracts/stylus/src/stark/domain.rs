...
pub fn domain_generator(log_size: u32) -> Fp {
...
pub fn evaluate_at(gen: Fp, index: u64) -> Fp {
...
mod tests {
    ...
    fn test_generator_2_28_is_primitive() {
        ...
        assert_ne!(val, Fp::ONE, "g^(2^27) == 1, not primitive");
    }
    ...
    fn test_domain_generator_k() {
        ...
        assert_eq!(result, Fp::ONE, "g_4^16 != 1");

        let half = BN254Field::pow(g4, U256::from(8u64));
        assert_ne!(half, Fp::ONE, "g_4^8 == 1, not primitive");
    }
    ...
    fn test_domain_generator_6() {
        ...
        assert_eq!(result, Fp::ONE, "g_6^64 != 1");
    }
    ...
    fn test_domain_generator_1() {
        ...
        assert_eq!(g1.to_u256(), BN254_PRIME - U256::from(1u64));
    }

    #[test]
    fn test_evaluate_at() {
        let g = domain_generator(4);
        assert_eq!(evaluate_at(g, 0), Fp::ONE);
